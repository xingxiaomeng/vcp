...
function createCatalog(ops) {
    return {
        ...
        searchOnlineMusic: query((options) => ops.invoke('music-search-online', options)),
        resolveOnlineMusicTrack: query((meta) => ops.invoke('music-resolve-online-track', meta)),
        refreshOnlineMusicTrack: query((track) => ops.invoke('music-refresh-online-track', track)),
        downloadOnlineMusicTrack: query((payload) => ops.invoke('music-download-online-track', payload)),
        chooseOnlineMusicDownloadDir: query(() => ops.invoke('music-choose-online-download-dir')),
        getOnlineMusicConfig: query(() => ops.invoke('music-get-online-config')),
        saveOnlineMusicConfig: query((config) => ops.invoke('music-save-online-config', config)),
...
const ALLOWED_KEYS = [
    ...
    "fetchMusicLyrics",
    "searchOnlineMusic",
    "resolveOnlineMusicTrack",
    "refreshOnlineMusicTrack",
    "downloadOnlineMusicTrack",
    "chooseOnlineMusicDownloadDir",
    "getOnlineMusicConfig",
    "saveOnlineMusicConfig",
    "queueNextMusicTrack",
    "cancelMusicPreload",
    "musicLoadIr",
    "musicUnloadIr",
