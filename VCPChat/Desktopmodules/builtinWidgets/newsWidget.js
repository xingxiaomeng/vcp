...
(function () {
    ...
    var NEWS_HTML = [
        ...
        '        try {',
        '            if (loadingEl) loadingEl.innerHTML = "📡 正在获取热点新闻...";',
        '            var data = await window.__vcpProxyFetch("/admin_api/dailyhot");',
        '            if (data && data.success === false) {',
        '                if (loadingEl) loadingEl.innerHTML = "❌ " + (data.error || "获取失败");',
        '                return;',
        '            }',
        '            var items = null;',
        ...
        '            if (!items) {',
        '                if (loadingEl) loadingEl.innerHTML = "❌ 数据格式异常";',
        '                return;',
        '            }',
        '            allNews = items;',
        '            if (allNews.length === 0) {',
        '                if (loadingEl) loadingEl.innerHTML = "暂无热点数据，请稍后刷新";',
        ...
        '            applyFilter();',
        '        } catch(e) {',
        '            if (loadingEl) loadingEl.innerHTML = "❌ 获取失败: " + e.message;',
